<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @hasrole('admin')
                        ...
                        <x-nav-link :href="route('reports.reservations.index')" :active="request()->routeIs('reports.reservations.index')">
                            {{ __('Reports') }}
                        </x-nav-link>
                    ...
                    @hasanyrole('approver_1|approver_2')
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('reports.reservations.index')" :active="request()->routeIs('reports.reservations.index')">
                {{ __('Reports') }}
            </x-responsive-nav-link>
